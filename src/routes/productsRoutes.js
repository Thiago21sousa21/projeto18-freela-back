...
import {
        deleteProduct, getCategory, getHeaderOptions, 
        getMyAds, getProductsHome, getSector1, getSector2, 
        getSectorProducts, getThisProduct, insertNewProduct 
...
productsRoutes.post('/deleteProduct',tokenValidation, deleteProduct );
